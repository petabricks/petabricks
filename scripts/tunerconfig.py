...
class config_defaults:
  ...
  lognorm_tunable_types       = ['system.cutoff.splitsize', 'system.cutoff.sequential', 'system.cutoff.distributed', 'system.flag.localmem', 'system.size.blocksize', 'system.gpuratio']
