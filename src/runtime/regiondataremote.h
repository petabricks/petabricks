...
namespace petabricks {
  ...
  public:
    ...
    // scratch
    void copyToScratchMatrixStorage(CopyToMatrixStorageMessage* origMetadata, size_t len, MatrixStoragePtr scratchStorage, MatrixRegionMetadata* scratchMetadata=0) const;
