...
int main( int argc, const char ** argv){
  ...
  for(bool isDone=false;!isDone;){
    ...
    o.comment("Compile with:");
    o.comment(cmdCppCompiler(outputCode, outputBin));
    o.newline();
    ...
    #endif
    o.newline();
    o.comment("File prefix");
    o.write(CodeGenerator::theFilePrefix().str());
    o.newline();
...
void callCppCompiler(const std::string& src, const std::string& bin){
  std::string cmd = cmdCppCompiler(src,bin);
